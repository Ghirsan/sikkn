<x-layouts::app :title="__('Program Kerja')">
    <div class="flex h-full w-full flex-1 flex-col gap-6 rounded-xl">
        ...
        <flux:card>
            ...
            <x-empty-state icon="light-bulb" :heading="__('Belum Ada Program Kerja')" :description="__('Program kerja yang diusulkan mahasiswa Program Studi Anda akan tampil di sini.')" />
        </flux:card>
    </div>
</x-layouts::app>
