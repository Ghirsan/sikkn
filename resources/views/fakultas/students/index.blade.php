        ...
        <div class="grid auto-rows-min gap-4 md:grid-cols-3">
            <div class="rounded-xl border border-neutral-200 p-4 dark:border-neutral-700">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <flux:text class="text-sm text-neutral-500 dark:text-neutral-400">{{ __('Total Peserta Fakultas') }}</flux:text>
            ...
            <div class="rounded-xl border border-neutral-200 p-4 dark:border-neutral-700">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <flux:text class="text-sm text-neutral-500 dark:text-neutral-400">{{ __('Program Studi Aktif') }}</flux:text>
                        <flux:text class="text-2xl font-bold">0</flux:text>
                    </div>
                </div>
            </div>
            <div class="rounded-xl border border-neutral-200 p-4 dark:border-neutral-700">
                <div class="flex items-center gap-3">
                    <div class="flex size-10 items-center justify-center rounded-lg bg-green-50 dark:bg-green-900/30">
                        <flux:icon name="clipboard-document-check" class="size-5 text-green-500" />
                    </div>
                    <div>
        ...
        <div class="rounded-xl border border-neutral-200 dark:border-neutral-700">
            ...
            <div class="px-6 py-12 text-center">
                ...
                <flux:text class="mt-2 text-sm text-neutral-500 dark:text-neutral-400">
                    {{ __('Data mahasiswa KKN dari seluruh Program Studi di bawah Fakultas akan tampil di sini setelah periode KKN aktif.') }}
                </flux:text>
            </div>
        </div>
    </div>
