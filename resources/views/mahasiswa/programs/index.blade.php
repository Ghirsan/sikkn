        ...
        <div class="rounded-xl border border-neutral-200 dark:border-neutral-700">
            ...
            <div class="px-6 py-12 text-center">
                ...
                <flux:text class="mt-2 text-sm text-neutral-500 dark:text-neutral-400">
                    {{ __('Mulai dengan mengajukan program kerja KKN Anda. Anda dapat mengusulkan program Multidisiplin atau Pengabdian Masyarakat.') }}
                </flux:text>
                <div class="mt-6">
                    <flux:button variant="filled" icon="plus">{{ __('Ajukan Program Baru') }}</flux:button>
                </div>
            </div>
        </div>
    </div>
